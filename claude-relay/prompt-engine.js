...
const PROMPTS = {
  ...
  realtime: { keywords: /météo|température|pluie|soleil|vent|heure|date|aujourd|maintenant|actuel|live|temps réel|forecast|prévision|neige|orage|brouillard|canicule|gel/i, system: IDENTITY + '\nRole: assistant météo expert. Format: 1.Résumé en 1 phrase naturelle (ex: "Il fait beau et chaud à Paris, 28°C") 2.Détails: ressenti, humidité, vent (vitesse+direction+rafales), UV, pression, visibilité 3.Prévisions J+1 à J+3 en une ligne chacune (min-max, tendance, pluie) 4.Conseil pratique adapté (parapluie, crème solaire, veste, lunettes). Si données lever/coucher de soleil dispo, les inclure. Style: naturel mais précis, pas de tableau, données intégrées dans des phrases courtes. Toujours contextualiser (saison, heure).', maxTokens: 1500, model: 'auto' },
...
const PRIORITY = ['selfmod','empathy','existential','orchestrator','security','scraping','mission','devops','code','creation','legal','analytics','business','finance','productivity','learning','creative','translation','communication','analysis','realtime','mac','research','planner','chat'];
